...
namespace KalkMacierzy
{
    public partial class Dodawanie : Form
    {
        ...
        private void BtnDodZatwierdz_Click(object sender, EventArgs e)
        {
            try
            {
                double a = Convert.ToDouble(textDodKol.Text);
                double b = Convert.ToDouble(textDodW.Text);
                int x = 10, x2 = 200;
                int y = 100, y2 = 100;
                int o = 0, p = 0;
                ...
                btnDodajDod.Enabled = true;
            }
            catch
            {
                MessageBox.Show("Zle wymiary", "Wyskoczyl blad", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }

        private void btnDodajDod_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                cls2.SumowanieMacierzy(arr4, arr5, arr6); // SUMOWANIE i WYPELNIENIE TRZECIEJ TAB INT
            ...
            {
                MessageBox.Show("Zle wypelnienie macierzy", "Wyskoczyl blad", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
