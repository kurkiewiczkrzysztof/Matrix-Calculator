...
namespace KalkMacierzy
{
    ...
    public partial class Mnozenie : Form
    {
        ...
        public static extern void MnozenieMacierzy(int[] pierwsza, int[] druga, int[] trzecia, double a, double b, double c, double d);
        ...
        private void btnZatwierdzODJ_Click(object sender, EventArgs e)
        {
            try
            {
                double a = Convert.ToDouble(textMNKol.Text);
                double b = Convert.ToDouble(textMNW.Text);
                double c = Convert.ToDouble(textMNKol2.Text);
                ...
                for (int j = 0; j < a; j++) // TWORZENIE DRUGIEJ PUSTEJ MACIERZY
                {
                ...
                btnMNDod.Enabled = true;
            }catch
            {
                MessageBox.Show("Zle wymiar", "Wyskoczyl blad", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }

        private void btnMNDod_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                double b = Convert.ToDouble(textMNW.Text);
                double c = Convert.ToDouble(textMNKol2.Text);
                double d = Convert.ToDouble(textMNKol.Text);
                int x = 100, y = 200;
                int dl4, dl5;
                dl4 = arr.Length;
                dl5 = arr2.Length;
                ...
                cls2.MnozenieMacierzy(arr4, arr5, arr6, a, b, c, d); // SUMOWANIE i WYPELNIENIE TRZECIEJ TAB INT
            ...
            {
                MessageBox.Show("Zle wypelnione macierze", "Wyskoczyl blad", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
}
}
